...
class VisionTransformer(BaseBackbone):
    ...
    Args:
        ...
        avg_token (bool): Whether or not to use the mean patch token for
            classification. If True, the models will only take the average
    ...
    def forward(self, x, image):
        ...
        # draw_feat(nlc_to_nchw(x[:, 1:], patch_resolution), visualizer, ori_img, draw_feat=True)
